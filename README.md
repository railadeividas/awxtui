...
| Tab | Choices |
| --- | --- |
| Jobs | started by anyone / me, or a typed username · status: any / pending / running / failed / successful, several at once · kind: any / jobs / project updates / inventory syncs, several at once · everything / pinned only |
...
options and `space` toggles the highlighted one in or out. Status and Kind
lead with an "any" entry, which is not a member
