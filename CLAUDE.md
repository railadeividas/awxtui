...
Ad-hoc commands, a workflow's own node graph (edges, approvals — node status
is shown), and creating or editing a workflow job template or a schedule.
See the "Not done yet" section of README.md.
